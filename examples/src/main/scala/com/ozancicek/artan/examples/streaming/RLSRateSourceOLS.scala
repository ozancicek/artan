...
import com.ozancicek.artan.ml.filter.RecursiveLeastSquaresFilter
 ...
 *
 * `spark-submit --class com.ozancicek.artan.examples.streaming.RLSRateSourceOLS artan-examples-assembly-VERSION.jar 10 10`
 */
